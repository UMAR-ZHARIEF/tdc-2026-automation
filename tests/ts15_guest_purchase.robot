...
...               that file's Documentation for capture scope and the PROVISIONAL
...
TC-15-001 Guest Completes Purchase Successfully
    ...
    ...    Test Case Specification's A16): order completed successfully (verified live,
...
TC-15-005 Offer Account Creation After Purchase
    ...
    ...    presented. Observed live: none; executing this TRUE offer-presence oracle is
